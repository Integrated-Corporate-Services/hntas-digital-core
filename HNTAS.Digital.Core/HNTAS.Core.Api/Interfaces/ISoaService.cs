...
namespace HNTAS.Core.Api.Interfaces
{
    public interface ISoaService
    {
        ...
        Task UpdateSoaStatus(string hnId, string elementId, SoaStage stage, List<SoaStatusWithCount> soaStatuses, string updatedBy, NetworkDetailsStatus elementSoaStatus);
