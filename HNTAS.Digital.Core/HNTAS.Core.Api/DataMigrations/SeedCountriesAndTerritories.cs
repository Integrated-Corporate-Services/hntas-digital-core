    ...
    public class SeedCountriesAndTerritories : IDataMigration
    {
        ...
        public async Task RunAsync()
        {
            ...
            if (count == 0)
            {
                ...
                {
                    new CountryAndTerritory { Name = "UK Crown Dependency - Guernsey, Alderney, Sark", FullValue = "territory:GG" },
                    new CountryAndTerritory { Name = "UK Crown Dependency - Jersey", FullValue = "territory:JE" },
                    new CountryAndTerritory { Name = "UK Crown Dependency - Isle of Man", FullValue = "territory:IM" },
                    new CountryAndTerritory { Name = "UK Territories - Anguilla", FullValue = "territory:AI" },
                    new CountryAndTerritory { Name = "UK Territories - Bermuda", FullValue = "territory:BM" },
                    new CountryAndTerritory { Name = "UK Territories - British Indian Ocean Territory", FullValue = "territory:IO" },
                    new CountryAndTerritory { Name = "UK Territories - British Virgin Islands", FullValue = "territory:VG" },
                    new CountryAndTerritory { Name = "UK Territories - Cayman Islands", FullValue = "territory:KY" },
                    new CountryAndTerritory { Name = "UK Territories - Falkland Islands", FullValue = "territory:FK" },
                    new CountryAndTerritory { Name = "UK Territories - Gibraltar", FullValue = "territory:GI" },
                    new CountryAndTerritory { Name = "UK Territories - Montserrat", FullValue = "territory:MS" },
                    new CountryAndTerritory { Name = "UK Territories - Pitcairn, Henderson, Ducie and Oeno Islands", FullValue = "territory:PN" },
                    new CountryAndTerritory { Name = "UK Territories - St Helena, Ascension and Tristan da Cunha", FullValue = "territory:SH" },
                    new CountryAndTerritory { Name = "UK Territories - South Georgia and South Sandwich Islands", FullValue = "territory:GS" },
                    new CountryAndTerritory { Name = "UK Territories - Turks and Caicos Islands", FullValue = "territory:TC" },
                    ...
                    new CountryAndTerritory { Name = "Brunei", FullValue = "country:BN" },
                    ...
                    new CountryAndTerritory { Name = "Congo", FullValue = "country:CG" },
                    new CountryAndTerritory { Name = "Congo (Democratic Republic)", FullValue = "country:CD" },
                    ...
                    new CountryAndTerritory { Name = "Czechia", FullValue = "country:CZ" },
                    ...
                    new CountryAndTerritory { Name = "Ivory Coast", FullValue = "country:CI" },
                    ...
                    new CountryAndTerritory { Name = "Federated States of Micronesia", FullValue = "country:FM" },
                    ...
                    new CountryAndTerritory { Name = "Palestine", FullValue = "country:PS" },
                    ...
                    new CountryAndTerritory { Name = "St Kitts and Nevis", FullValue = "country:KN" },
                    new CountryAndTerritory { Name = "St Lucia", FullValue = "country:LC" },
                    new CountryAndTerritory { Name = "St Vincent", FullValue = "country:VC" },
                    ...
                    new CountryAndTerritory { Name = "The Bahamas", FullValue = "country:BS" },
                    new CountryAndTerritory { Name = "The Gambia", FullValue = "country:GM" },
